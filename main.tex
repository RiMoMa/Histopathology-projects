...
% \begin{frame}{Results}
% ACC = 0.876 --- Fscore =  0.835
%     \begin{table}
% \centering
% \begin{tabular}{|c|c|c|c|c|c|c|} 
% \toprule
% CP*                        & Fiji*                      & Watershed & \textbf{Proposed} & \textbf{proposed 2} & CNN2*  & CNN3*   \\ 
% \hline
% 0.597 & 0.649 & 0.667     & 0.689 & 0.694    & 0.693 & 0.762  \\
% \bottomrule
% \end{tabular}
% \end{table}
% \centering
% Mean Dice Score. *Kumar et al. 2017
% \end{frame}


% \begin{frame}{Future Work}
% \begin{itemize}
%  \item To establish more metrics for segmentation commonly used as Hausdorff distance, Jaccard agregated index ..
%  \pause
%  \item to establish metrics for nuclei detection as F-score
%  \pause
%  \item Use the method to enhance the classification task between benign and malignant cell in a breast cancer data-set
% \end{itemize}
...
\multicolumn{4}{c}{Real}  & Baseline  \\
& 8x8    & 16x16  & 32x32    & Watershed \\  \hline \hline
Precision &  $0.745\pm 0.101$ & $0.748\pm 0.107$  & $0.746\pm 0.108 & $0.803\pm 0.096$     \\\hline
Recall  & $0.738\pm 0.085$  & $0.738\pm 0.086$  & $0.740\pm 0.086$  & $0.780\pm0.083$     
\end{tabular}
}
\end{table}
\end{frame}
